...
class ScriptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create script" do
    assert_difference("Script.count") do
      post scripts_url, params: { script: { as_file: @script.as_file, code: @script.code, description: @script.description, for_all_pages: @script.for_all_pages, link_tag: @script.link_tag } }
    end
  ...
  test "should update script" do
    patch script_url(@script), params: { script: { as_file: @script.as_file, code: @script.code, description: @script.description, for_all_pages: @script.for_all_pages, link_tag: @script.link_tag } }
